...
class PasswordStrengthCalculator : TextWatcher {
    ...
    private fun calculateStrength(password: CharSequence) {
        ...
        } else if (password.length in 8..10 && lowerCase.value == 1 && upperCase.value == 1) {
            strengthColor.value = R.color.medium
            strengthLevel.value = "Medium"
        } else if (password.length in 10..20 && lowerCase.value == 1 && upperCase.value == 1 && digit.value == 1 && specialChar.value == 1) {
